...
window.addEventListener("load", () => {
  let activities = document.getElementsByClassName("container");
  let newact = document.getElementById("btn");
  newact.addEventListener("click", () => {
    let input_act = document.getElementById("Activity").value;

    let input_category = document.getElementById("Category").value;
  ...
  sendbutton.addEventListener("click", () => {
    let message =
      window.name + " ➟ " + document.getElementById("my-message").value;
    socket.emit("message", {
      message: message,
    });
  });
